...
## 1. Introdução
Esta documentação detalha a integração entre a plataforma CX CORP e o sistema ERP para obter a posição financeira das contas a receber.
...
```bash
curl -X GET 'https://api.cxcorp.com/v1/contas/posicao_receber' \
...
```json
{
  "flow": [
    {
      "action": "Consulta posição financeira de contas a receber",
      "endpoint": "https://api.cxcorp.com/v1/contas/posicao_receber",
      "request": {},
